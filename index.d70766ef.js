...
})({"6pAtJ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "34387f8dd70766ef";
"use strict";
...
},{}],"WV6K7":[function(require,module,exports) {
...
parcelHelpers.export(exports, "productoServices", ()=>productoServices);
...
const eliminarProducto = (id)=>{
    return fetch(`http://localhost:3000/producto/${id}`, {
        ...
        if (response.ok) // La solicitud se completó con éxito, ahora puedes recargar la página
        refrescarPagina();
...
const actualizarProducto = (imgUrl, recomendado, nombre, precio, id)=>{
    ...
    }).then((respuesta)=>console.log(respuesta)).catch((error)=>{
...
},{}]},["6pAtJ","WV6K7"], "WV6K7", "parcelRequire94c2")

//# sourceMappingURL=index.d70766ef.js.map
